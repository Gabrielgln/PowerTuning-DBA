...
VALUES	('Processo Bloqueado',				'stpAlerta_Processo_Bloqueado',				1,		2,		'Minutos',			@Ds_Email),
		...
		('Conexão SQL Server',				'stpAlerta_Conexao_SQLServer',				1,		2000,	'Quantidade',		@Ds_Email),
		('Status Database',					'stpAlerta_Erro_Banco_Dados',				1,		NULL,	NULL,				@Ds_Email),
		('Página Corrompida',				'stpAlerta_Erro_Banco_Dados',				0,		NULL,	NULL,				@Ds_Email),
		...
		('Processos em Execução',			'stpEnvia_Email_Processos_Execucao',		0,		NULL,	NULL,				@Ds_Email)
